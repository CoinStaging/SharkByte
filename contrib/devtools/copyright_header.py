...
Arguments:
    <base_directory> - The base directory of a sharkbyte Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The sharkbyte Core developers'
...
Arguments:
    <base_directory> - The base directory of sharkbyte Core source code repository.
"""
...
Arguments:
    <file> - A source file in the sharkbyte Core repository.
"""

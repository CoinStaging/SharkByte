...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a sharkbyte address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sharkbyte: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about sharkbyte Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your sharkbyte addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified sharkbyte addresses"));
    ...
    openAction->setStatusTip(tr("Open a sharkbyte: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible sharkbyte command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("sharkbyte Core"); // default title
    ...
    // Append title to "sharkbyte Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

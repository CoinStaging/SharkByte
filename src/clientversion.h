...
//! These need to be macros, as clientversion.cpp's and sharkbyte*-res.rc's voodoo requires it
...
/**
 * sharkbyted-res.rc includes this file, but it cannot cope with real c++ code.

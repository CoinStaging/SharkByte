...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sharkbyte-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sharkbyte-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sharkbyte transaction") + "\n" +
              "  sharkbyte-tx [options] -create [commands]   " + _("Create hex-encoded sharkbyte transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sharkbyte transaction

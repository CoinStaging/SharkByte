...
#define BOOST_TEST_MODULE sharkbyte Test Suite

#include "test_sharkbyte.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_sharkbyte_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

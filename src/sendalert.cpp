...
2. run sharkbyted with -printalert or -sendalert like this:
   /path/to/sharkbyted -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.sharkbyte.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/sharkbyte Core:0.12.0.58/"));

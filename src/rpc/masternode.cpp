...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner sharkbyte address\n"
            "  payee          - Print the masternode payout sharkbyte address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting sharkbyte address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_500);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "sharkbyte",               "masternode",             &masternode,             true,  {} },
    { "sharkbyte",               "masternodelist",         &masternodelist,         true,  {} },
    { "sharkbyte",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "sharkbyte",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

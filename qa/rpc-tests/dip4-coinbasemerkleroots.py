...
from test_framework.test_framework import sharkbyteTestFramework
...
class LLMQCoinbaseCommitmentsTest(sharkbyteTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as sharkbyteTestFramework doesn't support this atm)

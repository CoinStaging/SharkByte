...
This document provides guidelines for internationalization of the sharkbyte Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sharkbyte_en.ts` remains unchanged.

...
This mechanism has been integrated into Bitcore-Node-sharkbyte which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sharkbytepay/insight-api-sharkbyte#web-socket-api](https://github.com/sharkbytepay/insight-api-sharkbyte#web-socket-api)
* API: [https://github.com/sharkbytepay/insight-api-sharkbyte#instantsend-transactions](https://github.com/sharkbytepay/insight-api-sharkbyte#instantsend-transactions)
